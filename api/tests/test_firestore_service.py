...
def firestore_service(mock_firestore_client):
    ...
    with patch('api.services.firestore_service.get_firestore_client', return_value=mock_firestore_client):
...
def test_get_user_organizations_returns_empty_list_when_no_orgs(firestore_service, mock_firestore_client):
